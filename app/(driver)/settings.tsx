  ...
  const settingSections: SettingSection[] = [
    {
      title: 'Account',
      items: [
        { label: 'Account Settings', icon: Users, route: '/account-settings' },
        { label: 'Vehicle Information', icon: Car, route: '/vehicle-info' },
        { label: 'Ride History', icon: History, route: '/ride-history' },
        { label: 'Earnings', icon: CreditCard, route: '/earnings' },
        { label: 'Emergency Contacts', icon: Shield, route: '/emergency-contacts' },
        { label: 'Ride Preferences', icon: Users, route: '/ride-preferences' },
      ]
    },
    {
      title: 'Notifications',
                ...
                { text: 'Cancel', style: 'cancel' },
                {
                  ...
                  onPress: async () => {
                    try {
                      ...
                      try { await deleteDoc(doc(firestore, 'users', user.uid)); } catch {}
